...
const SALES_DEPARTMENT = Object.freeze({
  ...
  teams: Object.freeze([
    Object.freeze({
      ...
      members: Object.freeze(['prospecting-orchestrator', 'prospecting', 'enrichment', 'scoring', 'growth-restart', 'targeted-campaign']),
  ...
  service_contracts: Object.freeze({
    owner_handoff: Object.freeze({
      ...
      assignee: 'owner',
      sla_hours: 24,
      accepted_when: 'owner-authenticated acceptance action records owner_accepted evidence before demo booking',
...
function buildSalesDepartmentReport({
  ...
  return {
    ...
    conversion_30d: {
      ...
      owner_acceptance_rate: rate(normalizedOutcomes.owner_accepted, normalizedOutcomes.human_reply),
