...
const FGA_KNOWLEDGE = {
  positioning: {
    ...
    one_liner: 'A platform that automates marketing, lead follow-up, customer communications, and review collection for small businesses, especially teams of 1-9 people.',
    delivery: 'Delivered via a branded mobile app and web portal. Live in 7 days.',
    audience: 'Small businesses in any industry. Teams of 1-9 are the sweet spot; teams of 10-19 may also fit. Known organizations with 20 or more employees are outside autonomous prospecting. No industry is excluded.',
