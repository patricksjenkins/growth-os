...
|---|---|---|
| Root regression run on implementation branch | Cross-cutting safety | 672 passed, 0 failed locally on 2026-07-24; the repository CI gate also performs secret scanning and real PostgreSQL migration execution. |
...
| Ephemeral PostgreSQL CI harness | G01, G04–G09, G12, G15–G20 and cross-cutting safety | Applies and reapplies migrations 067–084, proves atomic command denial/replay/conflict/cross-tenant behavior, exercises role/classification document RLS, ingestion/retrieval citations, incident reconciliation, closed-won onboarding, appointment projection/lifecycle, billing attribution, monthly finance close, content delivery/quality, client-health interventions, and lead-action outcomes; upgrades a simulated released migration-068 database through 084 without freezing legacy rows; and executes evidence-preserving containment rollbacks in reverse dependency order. The complete workflow is green in runs 30107697655 and 30108068259. |
