...
|---|---|---|
| Root regression run on implementation branch | Cross-cutting safety | 577 passed, 0 failed locally on 2026-07-24; the repository CI gate also performs secret scanning and real PostgreSQL migration execution. |
...
| Ephemeral PostgreSQL CI harness | G01, G04–G06, G15, G17, G18 and cross-cutting safety | Applies and reapplies migrations 067–079, proves atomic command denial/replay/conflict/cross-tenant behavior, exercises role/classification document RLS, incident reconciliation, closed-won onboarding, appointment projection/lifecycle, and billing attribution; upgrades a simulated released migration-068 database through 079 without freezing legacy rows; and executes evidence-preserving containment rollbacks. The 078/079 expansion is pending its first branch CI run. |
