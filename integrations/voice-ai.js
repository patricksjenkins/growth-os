...
function buildAssistantConfig(tenant, callContext = {}) {
  ...
  if (businessType === 'platform') {
    ...
    systemPrompt = [
      ...
      `    → "Great, our platform helps small businesses like yours automate lead follow-up and a few other things. What's your business name?"`,
      `    → Capture as B2B lead. classification = "new_lead".`,
      ``,
