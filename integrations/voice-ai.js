...
function buildAssistantConfig(tenant, callContext = {}) {
  ...
  if (businessType === 'platform') {
    ...
    systemPrompt = [
      ...
      `Don't say "Quick clarification so I can point you the right direction." Don't say "Got it, let me help you out." Just ask the next question.`,
      `Example openers in turn 2:`,
      `  - "What kind of service are you looking for?"`,
      `  - "Sure, what's the question about?"`,
      `  - "Got it — what's going on?"`,
      `Only get longer (2-3 sentences max) when:`,
      ...
      `  → NOW pivot once with: "Got it — we're actually a software platform, we don't do [their service] ourselves. Are you running a business that does that work?"`,
