...
function buildAssistantConfig(tenant, callContext = {}) {
  ...
  if (businessType === 'platform') {
    ...
    systemPrompt = [
      ...
      `    Turn E — listen to their answer (this is rich context for Patrick's callback). Acknowledge briefly and capture it in the notes field.`,
      `    Turn F — wrap up: "Got it. Patrick will give you a call back to walk through how it would work for [their business name]. What's your name?"`,
      `    Turn G — after name: "Thanks [name]. Have a great day."`,
      `    → Capture as B2B lead. classification = "new_lead". Put their answer to Turn D in the notes field — it's the most valuable piece of context for Patrick's follow-up.`,
      ``,
